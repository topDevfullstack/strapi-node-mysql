...
INSERT INTO `admin_permissions` VALUES (73, 'plugin::content-manager.explorer.create', 'api::category.category', '{\"fields\": [\"Name\", \"videos\"]}', '[]', '2022-10-23 14:20:00.413000', '2022-10-23 14:20:00.413000', NULL, NULL);
INSERT INTO `admin_permissions` VALUES (74, 'plugin::content-manager.explorer.create', 'api::video.video', '{\"fields\": [\"Title\", \"Content\", \"categories\"], \"locales\": [\"en\"]}', '[]', '2022-10-23 14:20:00.503000', '2022-10-23 14:20:00.503000', NULL, NULL);
INSERT INTO `admin_permissions` VALUES (75, 'plugin::content-manager.explorer.read', 'api::category.category', '{\"fields\": [\"Name\", \"videos\"]}', '[]', '2022-10-23 14:20:00.571000', '2022-10-23 14:20:00.571000', NULL, NULL);
INSERT INTO `admin_permissions` VALUES (76, 'plugin::content-manager.explorer.read', 'api::video.video', '{\"fields\": [\"Title\", \"Content\", \"categories\"], \"locales\": [\"en\"]}', '[]', '2022-10-23 14:20:00.623000', '2022-10-23 14:20:00.623000', NULL, NULL);
INSERT INTO `admin_permissions` VALUES (77, 'plugin::content-manager.explorer.update', 'api::category.category', '{\"fields\": [\"Name\", \"videos\"]}', '[]', '2022-10-23 14:20:00.669000', '2022-10-23 14:20:00.669000', NULL, NULL);
INSERT INTO `admin_permissions` VALUES (78, 'plugin::content-manager.explorer.update', 'api::video.video', '{\"fields\": [\"Title\", \"Content\", \"categories\"], \"locales\": [\"en\"]}', '[]', '2022-10-23 14:20:00.726000', '2022-10-23 14:20:00.726000', NULL, NULL);
...
INSERT INTO `admin_permissions_role_links` VALUES (73, 73, 1);
INSERT INTO `admin_permissions_role_links` VALUES (74, 74, 1);
INSERT INTO `admin_permissions_role_links` VALUES (75, 75, 1);
INSERT INTO `admin_permissions_role_links` VALUES (76, 76, 1);
INSERT INTO `admin_permissions_role_links` VALUES (77, 77, 1);
INSERT INTO `admin_permissions_role_links` VALUES (78, 78, 1);
...
-- ----------------------------
INSERT INTO `files_related_morphs` VALUES (3, 1, 1, 'api::video.video', 'Content', 1);
INSERT INTO `files_related_morphs` VALUES (4, 2, 2, 'api::video.video', 'Content', 1);
INSERT INTO `files_related_morphs` VALUES (5, 3, 3, 'api::video.video', 'Content', 1);
INSERT INTO `files_related_morphs` VALUES (6, 4, 4, 'api::video.video', 'Content', 1);
...
INSERT INTO `up_roles` VALUES (2, 'Public', 'Default role given to unauthenticated user.', 'public', '2022-10-23 13:21:59.261000', '2022-10-23 15:00:47.159000', NULL, NULL);
...
-- Records of videos
-- ----------------------------
INSERT INTO `videos` VALUES (1, 'W3', '2022-10-23 13:50:53.154000', '2022-10-23 14:20:28.649000', '2022-10-23 14:06:04.479000', 1, 1, 'en');
INSERT INTO `videos` VALUES (2, 'movie', '2022-10-23 13:51:43.834000', '2022-10-23 14:21:25.397000', '2022-10-23 14:06:14.029000', 1, 1, 'en');
INSERT INTO `videos` VALUES (3, 'today report', '2022-10-23 14:23:34.012000', '2022-10-23 14:24:33.360000', '2022-10-23 14:24:33.352000', 1, 1, 'en');
INSERT INTO `videos` VALUES (4, 'beauty and beast', '2022-10-23 14:24:08.749000', '2022-10-23 14:24:25.702000', '2022-10-23 14:24:25.695000', 1, 1, 'en');
...
CREATE TABLE `videos_categories_links`  (
  ...
  CONSTRAINT `videos_categories_links_fk` FOREIGN KEY (`video_id`) REFERENCES `videos` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `videos_categories_links_inv_fk` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of videos_categories_links
-- ----------------------------
INSERT INTO `videos_categories_links` VALUES (1, 1, 1);
INSERT INTO `videos_categories_links` VALUES (2, 2, 2);
INSERT INTO `videos_categories_links` VALUES (3, 3, 1);
INSERT INTO `videos_categories_links` VALUES (4, 4, 2);
