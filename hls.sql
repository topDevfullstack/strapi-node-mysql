...
INSERT INTO `admin_permissions` VALUES (71, 'plugin::content-manager.explorer.delete', 'api::category.category', '{}', '[]', '2022-10-23 14:17:56.517000', '2022-10-23 14:17:56.517000', NULL, NULL);
INSERT INTO `admin_permissions` VALUES (72, 'plugin::content-manager.explorer.publish', 'api::category.category', '{}', '[]', '2022-10-23 14:17:56.646000', '2022-10-23 14:17:56.646000', NULL, NULL);
INSERT INTO `admin_permissions` VALUES (88, 'plugin::content-manager.explorer.create', 'api::category.category', '{\"fields\": [\"name\", \"videos\"]}', '[]', '2022-10-24 04:22:17.436000', '2022-10-24 04:22:17.436000', NULL, NULL);
INSERT INTO `admin_permissions` VALUES (89, 'plugin::content-manager.explorer.read', 'api::category.category', '{\"fields\": [\"name\", \"videos\"]}', '[]', '2022-10-24 04:22:17.529000', '2022-10-24 04:22:17.529000', NULL, NULL);
INSERT INTO `admin_permissions` VALUES (90, 'plugin::content-manager.explorer.update', 'api::category.category', '{\"fields\": [\"name\", \"videos\"]}', '[]', '2022-10-24 04:22:17.572000', '2022-10-24 04:22:17.572000', NULL, NULL);
INSERT INTO `admin_permissions` VALUES (91, 'plugin::content-manager.explorer.create', 'api::video.video', '{\"fields\": [\"title\", \"content\", \"categories\", \"alternativeText\", \"caption\", \"hash\", \"ext\", \"mime\", \"size\", \"url\", \"provider\", \"width\", \"heught\"], \"locales\": [\"en\"]}', '[]', '2022-10-24 04:26:29.854000', '2022-10-24 04:26:29.854000', NULL, NULL);
INSERT INTO `admin_permissions` VALUES (92, 'plugin::content-manager.explorer.read', 'api::video.video', '{\"fields\": [\"title\", \"content\", \"categories\", \"alternativeText\", \"caption\", \"hash\", \"ext\", \"mime\", \"size\", \"url\", \"provider\", \"width\", \"heught\"], \"locales\": [\"en\"]}', '[]', '2022-10-24 04:26:30.021000', '2022-10-24 04:26:30.021000', NULL, NULL);
INSERT INTO `admin_permissions` VALUES (93, 'plugin::content-manager.explorer.update', 'api::video.video', '{\"fields\": [\"title\", \"content\", \"categories\", \"alternativeText\", \"caption\", \"hash\", \"ext\", \"mime\", \"size\", \"url\", \"provider\", \"width\", \"heught\"], \"locales\": [\"en\"]}', '[]', '2022-10-24 04:26:30.144000', '2022-10-24 04:26:30.144000', NULL, NULL);
...
INSERT INTO `admin_permissions_role_links` VALUES (71, 71, 1);
INSERT INTO `admin_permissions_role_links` VALUES (72, 72, 1);
INSERT INTO `admin_permissions_role_links` VALUES (88, 88, 1);
INSERT INTO `admin_permissions_role_links` VALUES (89, 89, 1);
INSERT INTO `admin_permissions_role_links` VALUES (90, 90, 1);
INSERT INTO `admin_permissions_role_links` VALUES (91, 91, 1);
INSERT INTO `admin_permissions_role_links` VALUES (92, 92, 1);
INSERT INTO `admin_permissions_role_links` VALUES (93, 93, 1);
...
CREATE TABLE `categories`  (
  ...
  `updated_by_id` int UNSIGNED NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `categories_created_by_id_fk`(`created_by_id` ASC) USING BTREE,
...
-- ----------------------------
INSERT INTO `categories` VALUES (1, 'news', '2022-10-23 14:19:10.304000', '2022-10-23 15:05:58.895000', '2022-10-23 15:05:58.889000', 1, 1);
INSERT INTO `categories` VALUES (2, 'film', '2022-10-23 14:20:52.489000', '2022-10-23 15:06:03.571000', '2022-10-23 15:06:03.568000', 1, 1);

-- ----------------------------
-- Table structure for categories_videos_links
-- ----------------------------
DROP TABLE IF EXISTS `categories_videos_links`;
CREATE TABLE `categories_videos_links`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `category_id` int UNSIGNED NULL DEFAULT NULL,
  `video_id` int UNSIGNED NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `categories_videos_links_fk`(`category_id` ASC) USING BTREE,
  INDEX `categories_videos_links_inv_fk`(`video_id` ASC) USING BTREE,
  CONSTRAINT `categories_videos_links_fk` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `categories_videos_links_inv_fk` FOREIGN KEY (`video_id`) REFERENCES `videos` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of categories_videos_links
-- ----------------------------
INSERT INTO `categories_videos_links` VALUES (1, 1, 1);
INSERT INTO `categories_videos_links` VALUES (2, 2, 2);
INSERT INTO `categories_videos_links` VALUES (3, 1, 3);
INSERT INTO `categories_videos_links` VALUES (4, 2, 4);
...
INSERT INTO `files` VALUES (3, 'today report.mp4', 'today report.mp4', 'today report.mp4', NULL, NULL, NULL, 'today_report_d9589a02c2', '.mp4', 'video/mp4', 318.46, '/uploads/today_report_d9589a02c2.mp4', NULL, 'local', NULL, '/', '2022-10-23 14:23:08.238000', '2022-10-23 14:23:08.238000', 1, 1);
INSERT INTO `files` VALUES (4, 'beauty and beast.mp4', 'beauty and beast.mp4', 'beauty and beast.mp4', NULL, NULL, NULL, 'beauty_and_beast_0af0d2b0ee', '.mp4', 'video/mp4', 318.46, '/uploads/beauty_and_beast_0af0d2b0ee.mp4', NULL, 'local', NULL, '/', '2022-10-23 14:24:02.382000', '2022-10-23 14:24:02.382000', 1, 1);
...
-- ----------------------------
INSERT INTO `files_related_morphs` VALUES (7, 1, 1, 'api::video.video', 'content', 1);
INSERT INTO `files_related_morphs` VALUES (8, 2, 2, 'api::video.video', 'content', 1);
INSERT INTO `files_related_morphs` VALUES (9, 3, 3, 'api::video.video', 'content', 1);
INSERT INTO `files_related_morphs` VALUES (10, 4, 4, 'api::video.video', 'content', 1);
...
INSERT INTO `strapi_core_store_settings` VALUES (20, 'plugin_content_manager_configuration_content_types::api::video.video', '{\"uid\":\"api::video.video\",\"settings\":{\"bulkable\":true,\"filterable\":true,\"searchable\":true,\"pageSize\":10,\"mainField\":\"id\",\"defaultSortBy\":\"id\",\"defaultSortOrder\":\"ASC\"},\"metadatas\":{\"id\":{\"edit\":{},\"list\":{\"label\":\"id\",\"searchable\":true,\"sortable\":true}},\"title\":{\"edit\":{\"label\":\"title\",\"description\":\"\",\"placeholder\":\"\",\"visible\":true,\"editable\":true},\"list\":{\"label\":\"title\",\"searchable\":true,\"sortable\":true}},\"content\":{\"edit\":{\"label\":\"content\",\"description\":\"\",\"placeholder\":\"\",\"visible\":true,\"editable\":true},\"list\":{\"label\":\"content\",\"searchable\":false,\"sortable\":false}},\"categories\":{\"edit\":{\"label\":\"categories\",\"description\":\"\",\"placeholder\":\"\",\"visible\":true,\"editable\":true,\"mainField\":\"id\"},\"list\":{\"label\":\"categories\",\"searchable\":false,\"sortable\":false}},\"alternativeText\":{\"edit\":{\"label\":\"alternativeText\",\"description\":\"\",\"placeholder\":\"\",\"visible\":true,\"editable\":true},\"list\":{\"label\":\"alternativeText\",\"searchable\":false,\"sortable\":false}},\"caption\":{\"edit\":{\"label\":\"caption\",\"description\":\"\",\"placeholder\":\"\",\"visible\":true,\"editable\":true},\"list\":{\"label\":\"caption\",\"searchable\":true,\"sortable\":true}},\"hash\":{\"edit\":{\"label\":\"hash\",\"description\":\"\",\"placeholder\":\"\",\"visible\":true,\"editable\":true},\"list\":{\"label\":\"hash\",\"searchable\":true,\"sortable\":true}},\"ext\":{\"edit\":{\"label\":\"ext\",\"description\":\"\",\"placeholder\":\"\",\"visible\":true,\"editable\":true},\"list\":{\"label\":\"ext\",\"searchable\":true,\"sortable\":true}},\"mime\":{\"edit\":{\"label\":\"mime\",\"description\":\"\",\"placeholder\":\"\",\"visible\":true,\"editable\":true},\"list\":{\"label\":\"mime\",\"searchable\":true,\"sortable\":true}},\"size\":{\"edit\":{\"label\":\"size\",\"description\":\"\",\"placeholder\":\"\",\"visible\":true,\"editable\":true},\"list\":{\"label\":\"size\",\"searchable\":true,\"sortable\":true}},\"url\":{\"edit\":{\"label\":\"url\",\"description\":\"\",\"placeholder\":\"\",\"visible\":true,\"editable\":true},\"list\":{\"label\":\"url\",\"searchable\":true,\"sortable\":true}},\"provider\":{\"edit\":{\"label\":\"provider\",\"description\":\"\",\"placeholder\":\"\",\"visible\":true,\"editable\":true},\"list\":{\"label\":\"provider\",\"searchable\":true,\"sortable\":true}},\"width\":{\"edit\":{\"label\":\"width\",\"description\":\"\",\"placeholder\":\"\",\"visible\":true,\"editable\":true},\"list\":{\"label\":\"width\",\"searchable\":true,\"sortable\":true}},\"heught\":{\"edit\":{\"label\":\"heught\",\"description\":\"\",\"placeholder\":\"\",\"visible\":true,\"editable\":true},\"list\":{\"label\":\"heught\",\"searchable\":true,\"sortable\":true}},\"createdAt\":{\"edit\":{\"label\":\"createdAt\",\"description\":\"\",\"placeholder\":\"\",\"visible\":false,\"editable\":true},\"list\":{\"label\":\"createdAt\",\"searchable\":true,\"sortable\":true}},\"updatedAt\":{\"edit\":{\"label\":\"updatedAt\",\"description\":\"\",\"placeholder\":\"\",\"visible\":false,\"editable\":true},\"list\":{\"label\":\"updatedAt\",\"searchable\":true,\"sortable\":true}}},\"layouts\":{\"edit\":[[{\"name\":\"title\",\"size\":6},{\"name\":\"content\",\"size\":6}],[{\"name\":\"alternativeText\",\"size\":12}],[{\"name\":\"caption\",\"size\":6},{\"name\":\"hash\",\"size\":6}],[{\"name\":\"ext\",\"size\":6},{\"name\":\"mime\",\"size\":6}],[{\"name\":\"size\",\"size\":6},{\"name\":\"url\",\"size\":6}],[{\"name\":\"provider\",\"size\":6},{\"name\":\"width\",\"size\":4}],[{\"name\":\"heught\",\"size\":4}]],\"editRelations\":[\"categories\"],\"list\":[\"id\",\"createdAt\",\"title\",\"content\",\"categories\",\"ext\",\"caption\",\"hash\",\"mime\",\"provider\",\"size\",\"url\"]}}', 'object', NULL, NULL);
INSERT INTO `strapi_core_store_settings` VALUES (21, 'plugin_content_manager_configuration_content_types::api::category.category', '{\"uid\":\"api::category.category\",\"settings\":{\"bulkable\":true,\"filterable\":true,\"searchable\":true,\"pageSize\":10,\"mainField\":\"id\",\"defaultSortBy\":\"id\",\"defaultSortOrder\":\"ASC\"},\"metadatas\":{\"id\":{\"edit\":{},\"list\":{\"label\":\"id\",\"searchable\":true,\"sortable\":true}},\"name\":{\"edit\":{\"label\":\"name\",\"description\":\"\",\"placeholder\":\"\",\"visible\":true,\"editable\":true},\"list\":{\"label\":\"name\",\"searchable\":true,\"sortable\":true}},\"videos\":{\"edit\":{\"label\":\"videos\",\"description\":\"\",\"placeholder\":\"\",\"visible\":true,\"editable\":true,\"mainField\":\"id\"},\"list\":{\"label\":\"videos\",\"searchable\":false,\"sortable\":false}},\"createdAt\":{\"edit\":{\"label\":\"createdAt\",\"description\":\"\",\"placeholder\":\"\",\"visible\":false,\"editable\":true},\"list\":{\"label\":\"createdAt\",\"searchable\":true,\"sortable\":true}},\"updatedAt\":{\"edit\":{\"label\":\"updatedAt\",\"description\":\"\",\"placeholder\":\"\",\"visible\":false,\"editable\":true},\"list\":{\"label\":\"updatedAt\",\"searchable\":true,\"sortable\":true}}},\"layouts\":{\"list\":[\"id\",\"createdAt\",\"updatedAt\",\"name\"],\"edit\":[[{\"name\":\"name\",\"size\":6}]],\"editRelations\":[\"videos\"]}}', 'object', NULL, NULL);
INSERT INTO `strapi_core_store_settings` VALUES (22, 'core_admin_project-settings', '{\"menuLogo\":{\"name\":\"favpng_logo-digital-signs-graphic-design.png\",\"hash\":\"favpng_logo_digital_signs_graphic_design_f843e4f827\",\"url\":\"/uploads/favpng_logo_digital_signs_graphic_design_f843e4f827.png\",\"width\":512,\"height\":512,\"ext\":\".png\",\"size\":25.24,\"provider\":\"local\"}}', 'object', NULL, NULL);
...
INSERT INTO `up_permissions` VALUES (10, 'api::category.category.findOne', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (11, 'api::category.category.find', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (12, 'api::category.category.update', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (13, 'api::category.category.create', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (14, 'api::video.video.find', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (15, 'api::video.video.update', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (16, 'api::video.video.delete', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (17, 'plugin::content-type-builder.components.getComponents', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (18, 'plugin::content-type-builder.components.getComponent', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (19, 'plugin::content-type-builder.content-types.getContentTypes', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (20, 'api::category.category.delete', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (21, 'api::video.video.create', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (22, 'plugin::email.email.send', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (23, 'plugin::content-type-builder.content-types.getContentType', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (24, 'plugin::upload.content-api.find', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (25, 'plugin::upload.content-api.findOne', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (26, 'plugin::upload.content-api.destroy', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (27, 'api::video.video.findOne', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (28, 'api::video.video.createLocalization', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (29, 'plugin::upload.content-api.upload', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (30, 'plugin::users-permissions.auth.changePassword', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (31, 'plugin::users-permissions.user.create', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (32, 'plugin::users-permissions.user.update', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (33, 'plugin::users-permissions.user.find', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (34, 'plugin::users-permissions.user.findOne', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (35, 'plugin::users-permissions.user.count', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (36, 'plugin::users-permissions.user.destroy', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (37, 'plugin::users-permissions.role.createRole', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (38, 'plugin::users-permissions.role.findOne', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (39, 'plugin::users-permissions.role.find', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (40, 'plugin::users-permissions.role.updateRole', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (41, 'plugin::users-permissions.role.deleteRole', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (42, 'plugin::users-permissions.user.me', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (43, 'plugin::users-permissions.permissions.getPermissions', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (44, 'plugin::i18n.locales.listLocales', '2022-10-23 15:00:47.317000', '2022-10-23 15:00:47.317000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (45, 'api::ftp-scan.ftp-scan.ftpScan', '2022-10-24 14:31:10.058000', '2022-10-24 14:31:10.058000', NULL, NULL);
INSERT INTO `up_permissions` VALUES (46, 'api::ftp-download.ftp-download.ftpDownload', '2022-10-25 12:50:42.993000', '2022-10-25 12:50:42.993000', NULL, NULL);
...
INSERT INTO `up_permissions_role_links` VALUES (10, 10, 2);
INSERT INTO `up_permissions_role_links` VALUES (11, 12, 2);
INSERT INTO `up_permissions_role_links` VALUES (12, 11, 2);
INSERT INTO `up_permissions_role_links` VALUES (13, 15, 2);
INSERT INTO `up_permissions_role_links` VALUES (14, 14, 2);
INSERT INTO `up_permissions_role_links` VALUES (15, 18, 2);
INSERT INTO `up_permissions_role_links` VALUES (16, 13, 2);
INSERT INTO `up_permissions_role_links` VALUES (17, 16, 2);
INSERT INTO `up_permissions_role_links` VALUES (18, 19, 2);
INSERT INTO `up_permissions_role_links` VALUES (19, 21, 2);
INSERT INTO `up_permissions_role_links` VALUES (20, 17, 2);
INSERT INTO `up_permissions_role_links` VALUES (21, 20, 2);
INSERT INTO `up_permissions_role_links` VALUES (22, 22, 2);
INSERT INTO `up_permissions_role_links` VALUES (23, 25, 2);
INSERT INTO `up_permissions_role_links` VALUES (24, 24, 2);
INSERT INTO `up_permissions_role_links` VALUES (25, 26, 2);
INSERT INTO `up_permissions_role_links` VALUES (26, 23, 2);
INSERT INTO `up_permissions_role_links` VALUES (27, 27, 2);
INSERT INTO `up_permissions_role_links` VALUES (28, 31, 2);
INSERT INTO `up_permissions_role_links` VALUES (29, 30, 2);
INSERT INTO `up_permissions_role_links` VALUES (30, 32, 2);
INSERT INTO `up_permissions_role_links` VALUES (31, 29, 2);
INSERT INTO `up_permissions_role_links` VALUES (32, 34, 2);
INSERT INTO `up_permissions_role_links` VALUES (33, 36, 2);
INSERT INTO `up_permissions_role_links` VALUES (34, 28, 2);
INSERT INTO `up_permissions_role_links` VALUES (35, 37, 2);
INSERT INTO `up_permissions_role_links` VALUES (36, 33, 2);
INSERT INTO `up_permissions_role_links` VALUES (37, 35, 2);
INSERT INTO `up_permissions_role_links` VALUES (38, 41, 2);
INSERT INTO `up_permissions_role_links` VALUES (39, 40, 2);
INSERT INTO `up_permissions_role_links` VALUES (40, 39, 2);
INSERT INTO `up_permissions_role_links` VALUES (41, 38, 2);
INSERT INTO `up_permissions_role_links` VALUES (42, 42, 2);
INSERT INTO `up_permissions_role_links` VALUES (43, 44, 2);
INSERT INTO `up_permissions_role_links` VALUES (44, 43, 2);
INSERT INTO `up_permissions_role_links` VALUES (45, 45, 2);
INSERT INTO `up_permissions_role_links` VALUES (46, 46, 2);
...
INSERT INTO `up_roles` VALUES (2, 'Public', 'Default role given to unauthenticated user.', 'public', '2022-10-23 13:21:59.261000', '2022-10-25 12:52:50.797000', NULL, NULL);
...
CREATE TABLE `videos`  (
  ...
  `alternative_text` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `caption` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `hash` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `ext` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `mime` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `size` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `url` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `provider` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `width` int NULL DEFAULT NULL,
  `heught` int NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of videos
-- ----------------------------
INSERT INTO `videos` VALUES (1, 'W3', '2022-10-23 13:50:53.154000', '2022-10-24 05:08:48.902000', '2022-10-23 14:06:04.479000', 1, 1, 'en', NULL, NULL, 'test-somerandomhashhere', 'mp4', 'video/mp4', '312KB', '/uploads/w3_8b6b4caf52.mp4', 'ftp://65.108.103.246:21', NULL, NULL);
INSERT INTO `videos` VALUES (2, 'movie', '2022-10-23 13:51:43.834000', '2022-10-24 05:09:07.496000', '2022-10-23 14:06:14.029000', 1, 1, 'en', NULL, NULL, 'test-somerandomhashhere', 'mp4', 'video/mp4', '312KB', '/uploads/movie_94608786e3.mp4', 'ftp://65.108.103.246:21', NULL, NULL);
INSERT INTO `videos` VALUES (3, 'today report', '2022-10-23 14:23:34.012000', '2022-10-24 05:09:22.907000', '2022-10-23 14:24:33.352000', 1, 1, 'en', NULL, NULL, 'test-somerandomhashhere', 'mp4', 'video/mp4', '312KB', '/uploads/today_report_d9589a02c2.mp4', 'ftp://65.108.103.246:21', NULL, NULL);
INSERT INTO `videos` VALUES (4, 'beauty and beast', '2022-10-23 14:24:08.749000', '2022-10-24 05:09:34.350000', '2022-10-23 14:24:25.695000', 1, 1, 'en', NULL, NULL, 'test-somerandomhashhere', 'mp4', 'video/mp4', '312KB', '/uploads/beauty_and_beast_0af0d2b0ee.mp4', 'ftp://65.108.103.246:21', NULL, NULL);
